...
+ **[Zuckerberg & Phelps](https://github.com/daniel-lobster/api_call_coingecko)** is a website I built that gives information on blockchain technology and crypto mining. I built the graphic user interface plus added a nice API call feature to show the price of crypto currencies. I made a 4-minute [YouTube video](https://youtu.be/82erXHt1dUE?si=rz0xQ9DXnzDbUf-i) showing how the API call works plus the site is live [here](http://crypto.miner.s3-website-us-west-1.amazonaws.com/). 
